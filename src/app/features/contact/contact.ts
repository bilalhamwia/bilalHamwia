        ...
        <a *ngFor="let link of socialLinks; let i = index"
          ...
          <div class="relative z-10 w-14 h-14 rounded-full flex items-center justify-center social-icon group-hover:bg-white/20"
            ...
            <ng-container [ngSwitch]="link.name">
              ...
              <svg *ngSwitchCase="'LinkedIn'" viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7 text-primary-start group-hover:text-white dark:text-white">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
              </svg>
              <svg *ngSwitchCase="'Email'" viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7 text-primary-start group-hover:text-white dark:text-white">
                <path d="M0 3v18h24V3H0zm6.623 7.929L2 16.558V6.686l4.623 4.243zm2.508 2.303l2.869 2.634 2.868-2.634L22 17.372H2l7.131-7.14zm4.246-2.303L22 6.686v9.872l-4.623-4.243z"/>
              </svg>
              <svg *ngSwitchCase="'WhatsApp'" viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7 text-primary-start group-hover:text-white dark:text-white">
              ...
              <svg *ngSwitchCase="'Instagram'" viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7 text-primary-start group-hover:text-white dark:text-white">
              ...
              <svg *ngSwitchCase="'Facebook'" viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7 text-primary-start group-hover:text-white dark:text-white">
