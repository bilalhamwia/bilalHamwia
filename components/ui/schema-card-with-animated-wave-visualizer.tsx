          ...
          <div className="relative card-border overflow-hidden rounded-2xl flex flex-col animate-float">
            <div className="p-4 flex justify-center relative">
              <div className="w-full h-48 rounded-xl gradient-border inner-glow overflow-hidden relative">
                ...
                {/* SVG connections & floating tables placeholder */}
                <div className="absolute inset-0 flex items-center justify-center">
                   <div className="w-24 h-24 bg-indigo-500/20 rounded-lg blur-xl animate-schemaPulse"></div>
                   <svg className="w-16 h-16 text-indigo-400 relative z-10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                     <path d="M4 7V4H20V7" strokeLinecap="round" strokeLinejoin="round"/>
                     <path d="M4 11V14H20V11" strokeLinecap="round" strokeLinejoin="round"/>
                     <path d="M4 17V20H20V17" strokeLinecap="round" strokeLinejoin="round"/>
                     <path d="M7 4V20" strokeLinecap="round" strokeLinejoin="round"/>
                     <path d="M17 4V20" strokeLinecap="round" strokeLinejoin="round"/>
                   </svg>
                </div>
              </div>
            </div>
